...
suite('Unit Tests', () => {
    ...
    suite('American to British English', () => {
        ...
        test('Translate "Mangoes are my favorite fruit." to British English', () => {
            ...
            assert.equal(translator.toBritishEnglish(input), expected);
        });
        ...
        suite('British to American English', () => {
            ...
            test('Translate "We watched the footie match for a while." to American English', () => {
                ...
                assert.equal(translator.toAmericanEnglish(input), expected);
            });
            ...
            test('Translate "I spent the bank holiday at the funfair." to American English', () => {
                ...
                const expected = 'I spent the bank holiday at the <span class="highlight">carnival</span>.';
                assert.equal(translator.toAmericanEnglish(input), expected);
            });
            ...
            test('Translate "I\'ve just got bits and bobs in my bum bag." to American English', () => {
                ...
                const expected = 'I\'ve just got bits and bobs in my <span class="highlight">fanny pack</span>.';
                assert.equal(translator.toAmericanEnglish(input), expected);
            });
